 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=t=>null===t||!("object"==typeof t||"function"==typeof t),x=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class _{constructor(t,e,i){this.dirty=!0,this.element=t,this.name=e,this.strings=i,this.parts=[];for(let t=0;t<i.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new S(this)}_getValue(){const t=this.strings,e=t.length-1;let i="";for(let s=0;s<e;s++){i+=t[s];const e=this.parts[s];if(void 0!==e){const t=e.value;if(y(t)||!x(t))i+="string"==typeof t?t:String(t);else for(const e of t)i+="string"==typeof e?e:String(e)}}return i+=t[e],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class S{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===m||y(t)&&t===this.value||(this.value=t,f(t)||(this.committer.dirty=!0))}commit(){for(;f(this.value);){const t=this.value;this.value=m,t(this)}this.value!==m&&this.committer.commit()}}class k{constructor(t){this.value=void 0,this.i=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(h()),this.endNode=t.appendChild(h())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.s(this.startNode=h()),t.s(this.endNode=h())}insertAfterPart(t){t.s(this.startNode=h()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.i=t}commit(){if(null===this.startNode.parentNode)return;for(;f(this.i);){const t=this.i;this.i=m,t(this)}const t=this.i;t!==m&&(y(t)?t!==this.value&&this.o(t):t instanceof w?this.h(t):t instanceof Node?this.l(t):x(t)?this.u(t):t===g?(this.value=g,this.clear()):this.o(t))}s(t){this.endNode.parentNode.insertBefore(t,this.endNode)}l(t){this.value!==t&&(this.clear(),this.s(t),this.value=t)}o(t){const e=this.startNode.nextSibling,i="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=i:this.l(document.createTextNode(i)),this.value=t}h(t){const e=this.options.templateFactory(t);if(this.value instanceof v&&this.value.template===e)this.value.update(t.values);else{const i=new v(e,t.processor,this.options),s=i._clone();i.update(t.values),this.l(s),this.value=i}}u(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let i,s=0;for(const n of t)i=e[s],void 0===i&&(i=new k(this.options),e.push(i),0===s?i.appendIntoPart(this):i.insertAfterPart(e[s-1])),i.setValue(n),i.commit(),s++;s<e.length&&(e.length=s,this.clear(i&&i.endNode))}clear(t=this.startNode){e(this.startNode.parentNode,t.nextSibling,this.endNode)}}class M{constructor(t,e,i){if(this.value=void 0,this.i=void 0,2!==i.length||""!==i[0]||""!==i[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=i}setValue(t){this.i=t}commit(){for(;f(this.i);){const t=this.i;this.i=m,t(this)}if(this.i===m)return;const t=!!this.i;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.i=m}}class $ extends _{constructor(t,e,i){super(t,e,i),this.single=2===i.length&&""===i[0]&&""===i[1]}_createPart(){return new C(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class C extends S{}let E=!1;(()=>{try{const t={get capture(){return E=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class A{constructor(t,e,i){this.value=void 0,this.i=void 0,this.element=t,this.eventName=e,this.eventContext=i,this.p=t=>this.handleEvent(t)}setValue(t){this.i=t}commit(){for(;f(this.i);){const t=this.i;this.i=m,t(this)}if(this.i===m)return;const t=this.i,e=this.value,i=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),s=null!=t&&(null==e||i);i&&this.element.removeEventListener(this.eventName,this.p,this.m),s&&(this.m=T(t),this.element.addEventListener(this.eventName,this.p,this.m)),this.value=t,this.i=m}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const T=t=>t&&(E?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function P(t){let e=F.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},F.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const n=t.strings.join(i);return s=e.keyString.get(n),void 0===s&&(s=new r(t,t.getTemplateElement()),e.keyString.set(n,s)),e.stringsArray.set(t.strings,s),s}const F=new Map,O=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const wt=t=>null===t||!("object"==typeof t||"function"==typeof t),yt=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class xt{constructor(t,e,i){this.dirty=!0,this.element=t,this.name=e,this.strings=i,this.parts=[];for(let t=0;t<i.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new _t(this)}_getValue(){const t=this.strings,e=t.length-1,i=this.parts;if(1===e&&""===t[0]&&""===t[1]){const t=i[0].value;if("symbol"==typeof t)return String(t);if("string"==typeof t||!yt(t))return t}let s="";for(let n=0;n<e;n++){s+=t[n];const e=i[n];if(void 0!==e){const t=e.value;if(wt(t)||!yt(t))s+="string"==typeof t?t:String(t);else for(const e of t)s+="string"==typeof e?e:String(e)}}return s+=t[e],s}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class _t{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===pt||wt(t)&&t===this.value||(this.value=t,dt(t)||(this.committer.dirty=!0))}commit(){for(;dt(this.value);){const t=this.value;this.value=pt,t(this)}this.value!==pt&&this.committer.commit()}}class St{constructor(t){this.value=void 0,this.i=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(at()),this.endNode=t.appendChild(at())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.s(this.startNode=at()),t.s(this.endNode=at())}insertAfterPart(t){t.s(this.startNode=at()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.i=t}commit(){if(null===this.startNode.parentNode)return;for(;dt(this.i);){const t=this.i;this.i=pt,t(this)}const t=this.i;t!==pt&&(wt(t)?t!==this.value&&this.o(t):t instanceof bt?this.h(t):t instanceof Node?this.l(t):yt(t)?this.u(t):t===ft?(this.value=ft,this.clear()):this.o(t))}s(t){this.endNode.parentNode.insertBefore(t,this.endNode)}l(t){this.value!==t&&(this.clear(),this.s(t),this.value=t)}o(t){const e=this.startNode.nextSibling,i="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=i:this.l(document.createTextNode(i)),this.value=t}h(t){const e=this.options.templateFactory(t);if(this.value instanceof mt&&this.value.template===e)this.value.update(t.values);else{const i=new mt(e,t.processor,this.options),s=i._clone();i.update(t.values),this.l(s),this.value=i}}u(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let i,s=0;for(const n of t)i=e[s],void 0===i&&(i=new St(this.options),e.push(i),0===s?i.appendIntoPart(this):i.insertAfterPart(e[s-1])),i.setValue(n),i.commit(),s++;s<e.length&&(e.length=s,this.clear(i&&i.endNode))}clear(t=this.startNode){X(this.startNode.parentNode,t.nextSibling,this.endNode)}}class kt{constructor(t,e,i){if(this.value=void 0,this.i=void 0,2!==i.length||""!==i[0]||""!==i[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=i}setValue(t){this.i=t}commit(){for(;dt(this.i);){const t=this.i;this.i=pt,t(this)}if(this.i===pt)return;const t=!!this.i;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.i=pt}}class Mt extends xt{constructor(t,e,i){super(t,e,i),this.single=2===i.length&&""===i[0]&&""===i[1]}_createPart(){return new $t(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class $t extends _t{}let Ct=!1;(()=>{try{const t={get capture(){return Ct=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class Et{constructor(t,e,i){this.value=void 0,this.i=void 0,this.element=t,this.eventName=e,this.eventContext=i,this.p=t=>this.handleEvent(t)}setValue(t){this.i=t}commit(){for(;dt(this.i);){const t=this.i;this.i=pt,t(this)}if(this.i===pt)return;const t=this.i,e=this.value,i=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),s=null!=t&&(null==e||i);i&&this.element.removeEventListener(this.eventName,this.p,this.m),s&&(this.m=At(t),this.element.addEventListener(this.eventName,this.p,this.m)),this.value=t,this.i=pt}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const At=t=>t&&(Ct?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function Tt(t){let e=Pt.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},Pt.set(t.type,e));let i=e.stringsArray.get(t.strings);if(void 0!==i)return i;const s=t.strings.join(tt);return i=e.keyString.get(s),void 0===i&&(i=new st(t,t.getTemplateElement()),e.keyString.set(s,i)),e.stringsArray.set(t.strings,i),i}const Pt=new Map,Ft=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const Yt={};class Zt extends Bt{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,i)=>t.reduceRight((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t),i),i=e(t,new Set),s=[];i.forEach(t=>s.unshift(t)),this._styles=s}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map(t=>{if(t instanceof CSSStyleSheet&&!Jt){const e=Array.prototype.slice.call(t.cssRules).reduce((t,e)=>t+e.cssText,"");return new Wt(String(e),Ht)}return t})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Jt?this.renderRoot.adoptedStyleSheets=t.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==Yt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return Yt}}Zt.finalized=!0,Zt.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const s=i.scopeName,n=Ft.has(e),r=zt&&11===e.nodeType&&!!e.host,a=r&&!Ut.has(s),o=a?document.createDocumentFragment():e;if(((t,e,i)=>{let s=Ft.get(e);void 0===s&&(X(e,e.firstChild),Ft.set(e,s=new St(Object.assign({templateFactory:Tt},i))),s.appendInto(e)),s.setValue(t),s.commit()})(t,o,Object.assign({templateFactory:Vt(s)},i)),a){const t=Ft.get(o);Ft.delete(o);const i=t.value instanceof mt?t.value.template:void 0;Lt(s,o,i),X(e,e.firstChild),e.appendChild(o),Ft.set(e,t)}!n&&r&&window.ShadyCSS.styleElement(e.host)};const Kt=new WeakMap;function Qt(t){return e=>{if(function(t,e){let i=e;for(;i;){if(Kt.get(i)===t)return!0;i=Object.getPrototypeOf(i)}return!1}(t,e))return e;const i=t(e);return Kt.set(i,t),i}}let Xt=Math.round(1e5*Math.random());const te="-|\\.|[0-9]|[a-z]",ee=new RegExp(`[a-z](${te})*-(${te})*`),ie=(t,e)=>{const i=`${t}-${Xt+=1}`;return((t,e)=>!!e.get(t))(i,e)?ie(t,e):i};function se(t,e=customElements){if(i=t,null===ee.exec(i))throw new Error("tagName is invalid");var i;return ie(t,e)}const ne=new Map,re=(t,e)=>ne.set(e,t),ae=(t,e,i=customElements)=>{re(t,e),i.define(t,class extends e{})},oe=(t,e,i)=>{const s=customElements;if(!(t=>Object.prototype.isPrototypeOf.call(HTMLElement,t))(e))return((t,e,i)=>{const s=se(t,e);if(!i)throw new Error("Lazy scoped elements requires the use of tags cache");return i.set(t,s),s})(t,s,i);if(e===customElements.get(t))return re(t,e),t;const n=se(t,s);return ae(n,e,s),n};function he(t,e,i){return(t=>ne.get(t))(e)||i&&i.get(t)||oe(t,e,i)}const ce=new RegExp("<\\/?([a-z](-|\\.|[0-9]|[a-z])*-(-|\\.|[0-9]|[a-z])*)","g"),le=new Map,ue=(t,e,i,s)=>{const n=t.map(t=>{let i=t;const n=(t=>{const e=[];let i;for(;null!==(i=ce.exec(t));)e.push(i);return e})(t);for(let t=n.length-1;t>=0;t-=1){const r=n[t],[a,o]=r,h=he(o,e[o],s),c=r.index+a.length-o.length,l=c+o.length,u=0===a.indexOf("</");i=i.slice(0,c)+(u?h:`${h} data-tag-name="${o}"`)+i.slice(l)}return i});return i.set(t,n),n};let de=!0;const{ShadyCSS:pe}=window;(void 0===pe||void 0===pe.prepareTemplateDom)&&(de=!1);const fe=new WeakMap,me=new WeakMap,ge=t=>(me.has(t)||me.set(t,new Map),me.get(t)),ve=(t,e,i,s)=>t.map(t=>t instanceof w?be(t,e,i,s):Array.isArray(t)?ve(t,e,i,s):t),be=(t,e,i,s)=>new w(function(t,e,i=le,s){return i.get(t)||ue(t,e,i,s)}(t.strings,e,i,s),ve(t.values,e,i,s),t.type,t.processor),we=(t,e,s,n)=>a=>{const o=be(a,e,s,n);return(t=>e=>{const s=((t,e)=>`${t}--${e}`)(e.type,t);let n=F.get(s);void 0===n&&(n={stringsArray:new WeakMap,keyString:new Map},F.set(s,n));let a=n.stringsArray.get(e.strings);if(void 0!==a)return a;const o=e.strings.join(i);if(a=n.keyString.get(o),void 0===a){const i=e.getTemplateElement();de&&pe.prepareTemplateDom(i,t),a=new r(e,i),n.keyString.set(o,a)}return n.stringsArray.set(e.strings,a),a})(t)(o)},ye=Qt(t=>class extends t{static get scopedElements(){return{}}static render(t,e,i){if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const{scopeName:s}=i,n=(r=this,fe.has(r)||fe.set(r,new Map),fe.get(r));var r;const a=ge(this),{scopedElements:o}=this;return super.render(t,e,{...i,templateFactory:we(s,o,n,a)})}defineScopedElement(t,e){return function(t,e,i){const s=i.get(t);s?void 0===customElements.get(s)&&ae(s,e,customElements):i.set(t,he(t,e,i))}(t,e,ge(this.constructor))}static getScopedTagName(t){const e=this.scopedElements[t];return e?he(t,e,ge(this)):ge(this).get(t)}}),xe=Qt(t=>class extends t{static get properties(){return{disabled:{type:Boolean,reflect:!0}}}constructor(){super(),this._requestedToBeDisabled=!1,this.g=!0,this.v=!1,this.disabled=!1}makeRequestToBeDisabled(){!1===this._requestedToBeDisabled&&(this._requestedToBeDisabled=!0,this.v=this.disabled,this._(!0))}retractRequestToBeDisabled(){!0===this._requestedToBeDisabled&&(this._requestedToBeDisabled=!1,this._(this.v))}_(t){this.g=!1,this.disabled=t,this.g=!0}requestUpdateInternal(t,e){super.requestUpdateInternal(t,e),"disabled"===t&&(this.g&&(this.v=this.disabled),!1===this.disabled&&!0===this._requestedToBeDisabled&&this._(!0))}}),_e=Qt(t=>class extends t{get slots(){return{}}constructor(){super(),this.S=new Set(null)}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this._connectSlotMixin()}_connectSlotMixin(){this.k||(Object.keys(this.slots).forEach(t=>{if(!this.querySelector(`[slot=${t}]`)){const e=(0,this.slots[t])();e instanceof Element&&(e.setAttribute("slot",t),this.appendChild(e),this.S.add(t))}}),this.k=!0)}_isPrivateSlot(t){return this.S.has(t)}}),Se=/Trident/.test(window.navigator.userAgent),ke=Qt(t=>class extends t{static get properties(){return{focused:{type:Boolean,reflect:!0}}}constructor(){super(),this.focused=!1}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this.M()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.$()}focus(){const t=this._inputNode;t&&t.focus()}blur(){const t=this._inputNode;t&&t.blur()}C(){this.focused=!0}A(){this.focused=!1}M(){this.T=t=>{t.stopPropagation(),this.dispatchEvent(new Event("focus"))},this._inputNode.addEventListener("focus",this.T),this.P=t=>{t.stopPropagation(),this.dispatchEvent(new Event("blur"))},this._inputNode.addEventListener("blur",this.P),this.F=t=>{t.stopPropagation(),this.C(),this.dispatchEvent(new Event("focusin",{bubbles:!0,composed:!0}))},this._inputNode.addEventListener("focusin",this.F),this.O=t=>{t.stopPropagation(),this.A(),this.dispatchEvent(new Event("focusout",{bubbles:!0,composed:!0}))},this._inputNode.addEventListener("focusout",this.O)}$(){this._inputNode.removeEventListener("focus",this.T),this._inputNode.removeEventListener("blur",this.P),this._inputNode.removeEventListener("focusin",this.F),this._inputNode.removeEventListener("focusout",this.O)}});class Me{constructor(t){this.type="unparseable",this.viewValue=t}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}}const $e=Qt(t=>class extends t{static get properties(){return{modelValue:{attribute:!1},formattedValue:{attribute:!1},serializedValue:{attribute:!1},formatOn:{attribute:!1},formatOptions:{attribute:!1}}}requestUpdateInternal(t,e){super.requestUpdateInternal(t,e),"modelValue"===t&&this.modelValue!==e&&this._onModelValueChanged({modelValue:this.modelValue},{modelValue:e}),"serializedValue"===t&&this.serializedValue!==e&&this._calculateValues({source:"serialized"}),"formattedValue"===t&&this.formattedValue!==e&&this._calculateValues({source:"formatted"})}parser(t,e){return t}formatter(t,e){return t}serializer(t){return void 0!==t?t:""}deserializer(t){return void 0===t?"":t}_calculateValues({source:t}={source:null}){this.N||(this.N=!0,"model"!==t&&("serialized"===t?this.modelValue=this.deserializer(this.serializedValue):"formatted"===t&&(this.modelValue=this.j())),"formatted"!==t&&(this.formattedValue=this.V()),"serialized"!==t&&(this.serializedValue=this.serializer(this.modelValue)),this._reflectBackFormattedValueToUser(),this.N=!1)}j(t=this.formattedValue){if(""===t)return"";if("string"!=typeof t)return;const e=this.parser(t,this.formatOptions);return void 0!==e?e:new Me(t)}V(){return this.I&&this.hasFeedbackFor&&this.hasFeedbackFor.length&&this.hasFeedbackFor.includes("error")&&this._inputNode?this._inputNode?this.value:void 0:this.modelValue instanceof Me?this.modelValue.viewValue:this.formatter(this.modelValue,this.formatOptions)}_onModelValueChanged(...t){this._calculateValues({source:"model"}),this._dispatchModelValueChangedEvent(...t)}_dispatchModelValueChangedEvent(){this.dispatchEvent(new CustomEvent("model-value-changed",{bubbles:!0,detail:{formPath:[this]}}))}_syncValueUpwards(){this.modelValue=this.j(this.value)}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=void 0!==this.formattedValue?this.formattedValue:"")}_reflectBackOn(){return!this.I}_proxyInputEvent(){this.dispatchEvent(new CustomEvent("user-input-changed",{bubbles:!0,composed:!0}))}_onUserInputChanged(){this.I=!0,this._syncValueUpwards(),this.I=!1}constructor(){super(),this.formatOn="change",this.formatOptions={}}connectedCallback(){super.connectedCallback(),this._reflectBackFormattedValueToUser=this._reflectBackFormattedValueToUser.bind(this),this._reflectBackFormattedValueDebounced=()=>{setTimeout(this._reflectBackFormattedValueToUser)},this.addEventListener("user-input-changed",this._onUserInputChanged),void 0===this.modelValue&&this._syncValueUpwards(),this._reflectBackFormattedValueToUser(),this._inputNode&&(this._inputNode.addEventListener(this.formatOn,this._reflectBackFormattedValueDebounced),this._inputNode.addEventListener("input",this._proxyInputEvent))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("user-input-changed",this._onUserInputChanged),this._inputNode&&(this._inputNode.removeEventListener("input",this._proxyInputEvent),this._inputNode.removeEventListener(this.formatOn,this._reflectBackFormattedValueDebounced))}}),Ce=Qt(t=>class extends t{connectedCallback(){super.connectedCallback&&super.connectedCallback(),this.dispatchEvent(new CustomEvent("form-element-register",{detail:{element:this},bubbles:!0}))}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.U&&this.U.removeFormElement(this)}});function Ee(t,{reverse:e}={}){const i=t.filter(t=>t);return i.sort((t,e)=>{const i=t.compareDocumentPosition(e);return i===Node.DOCUMENT_POSITION_PRECEDING||i===Node.DOCUMENT_POSITION_CONTAINED_BY?Se?-1:1:Se?1:-1}),e&&i.reverse(),i}const Ae=Qt(t=>class extends(Ce(_e(t))){static get properties(){return{name:{type:String,reflect:!0},label:String,helpText:{type:String,attribute:"help-text"},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.L||this._labelNode&&this._labelNode.textContent||""}set label(t){const e=this.label;this.L=t,this.requestUpdate("label",e)}get helpText(){return this.R||this._helpTextNode&&this._helpTextNode.textContent||""}set helpText(t){const e=this.helpText;this.R=t,this.requestUpdate("helpText",e)}get fieldName(){return this.D||this.label||this.name}set fieldName(t){this.D=t}get slots(){return{...super.slots,label:()=>{const t=document.createElement("label");return t.textContent=this.label,t},"help-text":()=>{const t=document.createElement("div");return t.textContent=this.helpText,t}}}updated(t){super.updated(t),t.has("_ariaLabelledNodes")&&this.B("aria-labelledby",this._ariaLabelledNodes,this.J),t.has("_ariaDescribedNodes")&&this.B("aria-describedby",this._ariaDescribedNodes,this.H),t.has("label")&&this._onLabelChanged({label:this.label}),t.has("helpText")&&this._onHelpTextChanged({helpText:this.helpText})}get _inputNode(){return this.W("input")}get _labelNode(){return this.W("label")}get _helpTextNode(){return this.W("help-text")}get _feedbackNode(){return this.W("feedback")}constructor(){super(),this._inputId=`${this.localName}-${Math.random().toString(36).substr(2,10)}`,this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole="child",this.addEventListener("model-value-changed",this.G)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent()}_triggerInitialModelValueChangedEvent(){this.Y()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add("form-control")}_enhanceLightDomA11y(){const{_inputNode:t,_labelNode:e,_helpTextNode:i,_feedbackNode:s}=this;t&&(t.id=t.id||this._inputId),e&&(e.setAttribute("for",this._inputId),this.addToAriaLabelledBy(e,{idPrefix:"label"})),i&&this.addToAriaDescribedBy(i,{idPrefix:"help-text"}),s&&(s.setAttribute("aria-live","polite"),this.addToAriaDescribedBy(s,{idPrefix:"feedback"})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(t=["prefix","suffix","before","after"]){t.forEach(t=>{const e=this.W(t);e&&(!0===e.hasAttribute("data-label")&&this.addToAriaLabelledBy(e,{idPrefix:t}),!0===e.hasAttribute("data-description")&&this.addToAriaDescribedBy(e,{idPrefix:t}))})}B(t,e,i){if(this._inputNode){if(i){const t=e.filter(t=>this.contains(t)),i=e.filter(t=>!this.contains(t));e=[...Ee(t),...i]}const s=e.map(t=>t.id).join(" ");this._inputNode.setAttribute(t,s)}}_onLabelChanged({label:t}){this._labelNode&&(this._labelNode.textContent=t)}_onHelpTextChanged({helpText:t}){this._helpTextNode&&(this._helpTextNode.textContent=t)}render(){return Nt`
      ...
      `}_inputGroupPrefixTemplate(){return Array.from(this.children).find(t=>"prefix"===t.slot)?Nt`
          ...
          `:ft}_inputGroupInputTemplate(){return Nt`
      ...
      `}_inputGroupSuffixTemplate(){return Array.from(this.children).find(t=>"suffix"===t.slot)?Nt`
          ...
          `:ft}_inputGroupAfterTemplate(){return Nt`
...
`;const ui="AIzaSyDpUdcXp0dJh6BO9oi9yADMIRYzGecIMLk",di="v-galaxy::iyt-dialogue-api::1.x",pi="v-galaxy::route-data-resolver-api::1.x",fi="v-galaxy::basic-event-emitter-api::1.x",mi={home:{part:["snippet"],maxResults:20,safeSearch:"strict"},movies:{part:["snippet"],maxResults:20,q:"marvel's movies",safeSearch:"strict"},learning:{part:["snippet"],maxResults:20,q:"Litelement, Angular, React tutorial",safeSearch:"strict"},subscriptions:void 0,"not-found":void 0};customElements.define("fa-icon",class extends K{static get properties(){return{color:String,iClass:{attribute:"class"},src:String,style:String,size:String,pathPrefix:{attribute:"path-prefix"}}}static get styles(){return Y`
    ...
    `}});customElements.define("app-logo-element",class extends K{static get styles(){return Y`
        ...
        `]}openDrawer(t){this.shadowRoot.getElementById("drawer").style.width="250px",t.preventDefault()}closeDrawer(t){this.shadowRoot.getElementById("drawer").style.width="0"}firstUpdated(){const t=new URLSearchParams(location.search).get("q");this.shadowRoot.getElementById("searchInput").value=t}searchClick(t){this.navigate("search?q="+this.shadowRoot.getElementById("searchInput").value),Pe.get(fi).emit("start-search")}render(){return j`
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const vi=(t,e)=>{const i=t.startNode.parentNode,s=void 0===e?t.endNode:e.startNode,n=i.insertBefore(h(),s);i.insertBefore(h(),s);const r=new k(t.options);return r.insertAfterNode(n),r},bi=(t,e)=>(t.setValue(e),t.commit(),t),wi=(t,e,i)=>{const s=t.startNode.parentNode,n=i?i.startNode:t.endNode,r=e.endNode.nextSibling;r!==n&&((t,e,i=null,s=null)=>{for(;e!==i;){const i=e.nextSibling;t.insertBefore(e,s),e=i}})(s,e.startNode,r,n)},yi=t=>{e(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},xi=(t,e,i)=>{const s=new Map;for(let n=e;n<=i;n++)s.set(t[n],n);return s},_i=new WeakMap,Si=new WeakMap,ki=(t=>(...e)=>{const i=t(...e);return p.set(i,!0),i})((t,e,i)=>{let s;return void 0===i?i=e:void 0!==e&&(s=e),e=>{if(!(e instanceof k))throw new Error("repeat can only be used in text bindings");const n=_i.get(e)||[],r=Si.get(e)||[],a=[],o=[],h=[];let c,l,u=0;for(const e of t)h[u]=s?s(e,u):u,o[u]=i(e,u),u++;let d=0,p=n.length-1,f=0,m=o.length-1;for(;d<=p&&f<=m;)if(null===n[d])d++;else if(null===n[p])p--;else if(r[d]===h[f])a[f]=bi(n[d],o[f]),d++,f++;else if(r[p]===h[m])a[m]=bi(n[p],o[m]),p--,m--;else if(r[d]===h[m])a[m]=bi(n[d],o[m]),wi(e,n[d],a[m+1]),d++,m--;else if(r[p]===h[f])a[f]=bi(n[p],o[f]),wi(e,n[p],n[d]),p--,f++;else if(void 0===c&&(c=xi(h,f,m),l=xi(r,d,p)),c.has(r[d]))if(c.has(r[p])){const t=l.get(h[f]),i=void 0!==t?n[t]:null;if(null===i){const t=vi(e,n[d]);bi(t,o[f]),a[f]=t}else a[f]=bi(i,o[f]),wi(e,i,n[d]),n[t]=null;f++}else yi(n[p]),p--;else yi(n[d]),d++;for(;f<=m;){const t=vi(e,a[m+1]);bi(t,o[f]),a[f++]=t}for(;d<=p;){const t=n[d++];null!==t&&yi(t)}_i.set(e,a),Si.set(e,h)}});customElements.define("video-grid-element",class extends K{constructor(){super()}static get properties(){return{snippet:{type:Object},heading:{type:String}}}static get styles(){return Y`
            :host {
                display: block;
            }
    ...
    `}render(){let t=j`<div class="no-search">
            ...
            </section>`}return t}});customElements.define("home-contents-element",class extends K{constructor(){super(),this.ytApi=Pe.get(di)}static get properties(){return{data:{type:Object}}}static get styles(){return Y`
            :host {
                display: block;
            }
        `}async connectedCallback(){this.recommendedData=await this.ytApi.loadContents(mi.home),super.connectedCallback()}render(){return j`<video-grid-element snippet='${JSON.stringify(this.recommendedData)}' heading='Pick for you'></video-grid-element>`}});customElements.define("movies-contents-element",class extends K{constructor(){super(),this.ytApi=Pe.get(di)}static get styles(){return Y`
            :host {
                display: block;
            }
        `}async connectedCallback(){try{this.moviesData=await this.ytApi.loadContents(mi.movies)}catch{this.requestUpdate()}super.connectedCallback()}render(){return j`<video-grid-element snippet='${JSON.stringify(this.moviesData)}' heading='Movies'></video-grid-element>`}});customElements.define("search-contents-element",class extends K{constructor(){super(),this.eventEmitter=Pe.get(fi),this.eventEmitter.subscribe("start-search",this.search.bind(this)),this.ytApi=Pe.get(di)}static get styles(){return Y`
            :host {
                display: block;
            }
        ...
        `}async connectedCallback(){this.learningData=await this.ytApi.loadContents(mi.learning),super.connectedCallback()}render(){return j`<video-grid-element snippet='${JSON.stringify(this.learningData)}' heading='Learning tutorials'></video-grid-element>`}});class Mi{constructor(){this.initGoogleApi()}initGoogleApi(){"undefined"!=typeof gapi&&(gapi.load("client"),gapi.client.setApiKey(ui))}async loadYoutubeApi(){if("undefined"!=typeof gapi&&navigator.onLine){await gapi.client.load("https://www.googleapis.com/discovery/v1/apis/youtube/v3/rest")}else await new Promise(t=>t(void 0))}async loadContents(t){return await this.loadYoutubeApi(),navigator.onLine?gapi.client.youtube.search.list(t):void 0}}class $i extends(function(t){return class extends t{static get properties(){return{activeRoute:{type:String,reflect:!0,attribute:"active-route"}}}attributeChangedCallback(...t){super.attributeChangedCallback(...t),t.some(t=>"active-route"===t)&&this.outlet()}connectedCallback(...t){super.connectedCallback(...t),setTimeout(()=>{this.outlet()})}outlet(){Array.from(this.querySelectorAll("[route]")).map(t=>{t.style.display="none"}),Array.from(this.shadowRoot.querySelectorAll("[route]")).map(t=>{t.style.display="none"}),this.activeRoute&&(Array.from(this.querySelectorAll(`[route~=${this.activeRoute}]`)).map(t=>{t.style.display=""}),Array.from(this.shadowRoot.querySelectorAll(`[route~=${this.activeRoute}]`)).map(t=>{t.style.display=""}))}}}(K)){render(){return j`
      <slot></slot>
    `}}customElements.define("main-wrapper",$i);class Ci{constructor(){this.ytApi=Pe.get(di)}async getContents(t){return this.data=await this.ytApi.loadContents(mi[t]),this.data}}class Ei{constructor(){this.events={}}subscribe(t,e){this.events[t]=this.events[t]||[],this.events[t].push(e)}unSubscribe(t,e){if(this.events[t])for(let i=0;i<this.events[t].length;i++)if(this.events[t][i]===e){this.events[t].splice(i,1);break}}emit(t,e){this.events[t]&&this.events[t].forEach((function(t){t.constructor&&"AsyncFunction"===t.constructor.name?async function(){await t(e)}():t(e)}))}}class Ai extends(oi(K)){static get styles(){return Y`
      .container {
        padding:14px;
      }
