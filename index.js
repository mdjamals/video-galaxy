 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=t=>null===t||!("object"==typeof t||"function"==typeof t),_=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class x{constructor(t,e,i){this.dirty=!0,this.element=t,this.name=e,this.strings=i,this.parts=[];for(let t=0;t<i.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new S(this)}_getValue(){const t=this.strings,e=t.length-1;let i="";for(let s=0;s<e;s++){i+=t[s];const e=this.parts[s];if(void 0!==e){const t=e.value;if(y(t)||!_(t))i+="string"==typeof t?t:String(t);else for(const e of t)i+="string"==typeof e?e:String(e)}}return i+=t[e],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class S{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===m||y(t)&&t===this.value||(this.value=t,p(t)||(this.committer.dirty=!0))}commit(){for(;p(this.value);){const t=this.value;this.value=m,t(this)}this.value!==m&&this.committer.commit()}}class k{constructor(t){this.value=void 0,this.i=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(h()),this.endNode=t.appendChild(h())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.s(this.startNode=h()),t.s(this.endNode=h())}insertAfterPart(t){t.s(this.startNode=h()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.i=t}commit(){if(null===this.startNode.parentNode)return;for(;p(this.i);){const t=this.i;this.i=m,t(this)}const t=this.i;t!==m&&(y(t)?t!==this.value&&this.o(t):t instanceof w?this.h(t):t instanceof Node?this.l(t):_(t)?this.u(t):t===g?(this.value=g,this.clear()):this.o(t))}s(t){this.endNode.parentNode.insertBefore(t,this.endNode)}l(t){this.value!==t&&(this.clear(),this.s(t),this.value=t)}o(t){const e=this.startNode.nextSibling,i="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=i:this.l(document.createTextNode(i)),this.value=t}h(t){const e=this.options.templateFactory(t);if(this.value instanceof v&&this.value.template===e)this.value.update(t.values);else{const i=new v(e,t.processor,this.options),s=i._clone();i.update(t.values),this.l(s),this.value=i}}u(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let i,s=0;for(const n of t)i=e[s],void 0===i&&(i=new k(this.options),e.push(i),0===s?i.appendIntoPart(this):i.insertAfterPart(e[s-1])),i.setValue(n),i.commit(),s++;s<e.length&&(e.length=s,this.clear(i&&i.endNode))}clear(t=this.startNode){e(this.startNode.parentNode,t.nextSibling,this.endNode)}}class M{constructor(t,e,i){if(this.value=void 0,this.i=void 0,2!==i.length||""!==i[0]||""!==i[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=i}setValue(t){this.i=t}commit(){for(;p(this.i);){const t=this.i;this.i=m,t(this)}if(this.i===m)return;const t=!!this.i;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.i=m}}class C extends x{constructor(t,e,i){super(t,e,i),this.single=2===i.length&&""===i[0]&&""===i[1]}_createPart(){return new E(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class E extends S{}let $=!1;(()=>{try{const t={get capture(){return $=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class A{constructor(t,e,i){this.value=void 0,this.i=void 0,this.element=t,this.eventName=e,this.eventContext=i,this.p=t=>this.handleEvent(t)}setValue(t){this.i=t}commit(){for(;p(this.i);){const t=this.i;this.i=m,t(this)}if(this.i===m)return;const t=this.i,e=this.value,i=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),s=null!=t&&(null==e||i);i&&this.element.removeEventListener(this.eventName,this.p,this.m),s&&(this.m=T(t),this.element.addEventListener(this.eventName,this.p,this.m)),this.value=t,this.i=m}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const T=t=>t&&($?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,s){const n=e[0];if("."===n){return new C(t,e.slice(1),i).parts}return"@"===n?[new A(t,e.slice(1),s.eventContext)]:"?"===n?[new M(t,e.slice(1),i)]:new x(t,e,i).parts}handleTextExpression(t){return new k(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const wt=t=>null===t||!("object"==typeof t||"function"==typeof t),yt=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class _t{constructor(t,e,i){this.dirty=!0,this.element=t,this.name=e,this.strings=i,this.parts=[];for(let t=0;t<i.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new xt(this)}_getValue(){const t=this.strings,e=t.length-1,i=this.parts;if(1===e&&""===t[0]&&""===t[1]){const t=i[0].value;if("symbol"==typeof t)return String(t);if("string"==typeof t||!yt(t))return t}let s="";for(let n=0;n<e;n++){s+=t[n];const e=i[n];if(void 0!==e){const t=e.value;if(wt(t)||!yt(t))s+="string"==typeof t?t:String(t);else for(const e of t)s+="string"==typeof e?e:String(e)}}return s+=t[e],s}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class xt{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===ft||wt(t)&&t===this.value||(this.value=t,dt(t)||(this.committer.dirty=!0))}commit(){for(;dt(this.value);){const t=this.value;this.value=ft,t(this)}this.value!==ft&&this.committer.commit()}}class St{constructor(t){this.value=void 0,this.i=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(at()),this.endNode=t.appendChild(at())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.s(this.startNode=at()),t.s(this.endNode=at())}insertAfterPart(t){t.s(this.startNode=at()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.i=t}commit(){if(null===this.startNode.parentNode)return;for(;dt(this.i);){const t=this.i;this.i=ft,t(this)}const t=this.i;t!==ft&&(wt(t)?t!==this.value&&this.o(t):t instanceof bt?this.h(t):t instanceof Node?this.l(t):yt(t)?this.u(t):t===pt?(this.value=pt,this.clear()):this.o(t))}s(t){this.endNode.parentNode.insertBefore(t,this.endNode)}l(t){this.value!==t&&(this.clear(),this.s(t),this.value=t)}o(t){const e=this.startNode.nextSibling,i="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=i:this.l(document.createTextNode(i)),this.value=t}h(t){const e=this.options.templateFactory(t);if(this.value instanceof mt&&this.value.template===e)this.value.update(t.values);else{const i=new mt(e,t.processor,this.options),s=i._clone();i.update(t.values),this.l(s),this.value=i}}u(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let i,s=0;for(const n of t)i=e[s],void 0===i&&(i=new St(this.options),e.push(i),0===s?i.appendIntoPart(this):i.insertAfterPart(e[s-1])),i.setValue(n),i.commit(),s++;s<e.length&&(e.length=s,this.clear(i&&i.endNode))}clear(t=this.startNode){X(this.startNode.parentNode,t.nextSibling,this.endNode)}}class kt{constructor(t,e,i){if(this.value=void 0,this.i=void 0,2!==i.length||""!==i[0]||""!==i[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=i}setValue(t){this.i=t}commit(){for(;dt(this.i);){const t=this.i;this.i=ft,t(this)}if(this.i===ft)return;const t=!!this.i;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.i=ft}}class Mt extends _t{constructor(t,e,i){super(t,e,i),this.single=2===i.length&&""===i[0]&&""===i[1]}_createPart(){return new Ct(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class Ct extends xt{}let Et=!1;(()=>{try{const t={get capture(){return Et=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class $t{constructor(t,e,i){this.value=void 0,this.i=void 0,this.element=t,this.eventName=e,this.eventContext=i,this.p=t=>this.handleEvent(t)}setValue(t){this.i=t}commit(){for(;dt(this.i);){const t=this.i;this.i=ft,t(this)}if(this.i===ft)return;const t=this.i,e=this.value,i=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),s=null!=t&&(null==e||i);i&&this.element.removeEventListener(this.eventName,this.p,this.m),s&&(this.m=At(t),this.element.addEventListener(this.eventName,this.p,this.m)),this.value=t,this.i=ft}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const At=t=>t&&(Et?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,s){const n=e[0];if("."===n){return new Mt(t,e.slice(1),i).parts}return"@"===n?[new $t(t,e.slice(1),s.eventContext)]:"?"===n?[new kt(t,e.slice(1),i)]:new _t(t,e,i).parts}handleTextExpression(t){return new St(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const Zt={};class Kt extends qt{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,i)=>t.reduceRight((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t),i),i=e(t,new Set),s=[];i.forEach(t=>s.unshift(t)),this._styles=s}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map(t=>{if(t instanceof CSSStyleSheet&&!Ht){const e=Array.prototype.slice.call(t.cssRules).reduce((t,e)=>t+e.cssText,"");return new Wt(String(e),Jt)}return t})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Ht?this.renderRoot.adoptedStyleSheets=t.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==Zt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return Zt}}Kt.finalized=!0,Kt.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const s=i.scopeName,n=Pt.has(e),r=Vt&&11===e.nodeType&&!!e.host,a=r&&!It.has(s),o=a?document.createDocumentFragment():e;if(((t,e,i)=>{let s=Pt.get(e);void 0===s&&(X(e,e.firstChild),Pt.set(e,s=new St(Object.assign({templateFactory:Tt},i))),s.appendInto(e)),s.setValue(t),s.commit()})(t,o,Object.assign({templateFactory:zt(s)},i)),a){const t=Pt.get(o);Pt.delete(o);const i=t.value instanceof mt?t.value.template:void 0;Lt(s,o,i),X(e,e.firstChild),e.appendChild(o),Pt.set(e,t)}!n&&r&&window.ShadyCSS.styleElement(e.host)};const Yt=new WeakMap;function Qt(t){return e=>{if(function(t,e){let i=e;for(;i;){if(Yt.get(i)===t)return!0;i=Object.getPrototypeOf(i)}return!1}(t,e))return e;const i=t(e);return Yt.set(i,t),i}}let Xt=Math.round(1e5*Math.random());const te="-|\\.|[0-9]|[a-z]",ee=new RegExp(`[a-z](${te})*-(${te})*`),ie=(t,e)=>{const i=`${t}-${Xt+=1}`;return((t,e)=>!!e.get(t))(i,e)?ie(t,e):i};function se(t,e=customElements){if(i=t,null===ee.exec(i))throw new Error("tagName is invalid");var i;return ie(t,e)}const ne=new Map,re=(t,e)=>ne.set(e,t),ae=(t,e,i=customElements)=>{re(t,e),i.define(t,class extends e{})},oe=(t,e,i)=>{const s=customElements;if(!(t=>Object.prototype.isPrototypeOf.call(HTMLElement,t))(e))return((t,e,i)=>{const s=se(t,e);if(!i)throw new Error("Lazy scoped elements requires the use of tags cache");return i.set(t,s),s})(t,s,i);if(e===customElements.get(t))return re(t,e),t;const n=se(t,s);return ae(n,e,s),n};function he(t,e,i){return(t=>ne.get(t))(e)||i&&i.get(t)||oe(t,e,i)}const ce=new RegExp("<\\/?([a-z](-|\\.|[0-9]|[a-z])*-(-|\\.|[0-9]|[a-z])*)","g"),le=new Map,ue=(t,e,i,s)=>{const n=t.map(t=>{let i=t;const n=(t=>{const e=[];let i;for(;null!==(i=ce.exec(t));)e.push(i);return e})(t);for(let t=n.length-1;t>=0;t-=1){const r=n[t],[a,o]=r,h=he(o,e[o],s),c=r.index+a.length-o.length,l=c+o.length,u=0===a.indexOf("</");i=i.slice(0,c)+(u?h:`${h} data-tag-name="${o}"`)+i.slice(l)}return i});return i.set(t,n),n};let de=!0;const{ShadyCSS:fe}=window;(void 0===fe||void 0===fe.prepareTemplateDom)&&(de=!1);const pe=new WeakMap,me=new WeakMap,ge=t=>(me.has(t)||me.set(t,new Map),me.get(t)),ve=(t,e,i,s)=>t.map(t=>t instanceof w?be(t,e,i,s):Array.isArray(t)?ve(t,e,i,s):t),be=(t,e,i,s)=>new w(function(t,e,i=le,s){return i.get(t)||ue(t,e,i,s)}(t.strings,e,i,s),ve(t.values,e,i,s),t.type,t.processor),we=(t,e,s,n)=>a=>{const o=be(a,e,s,n);return(t=>e=>{const s=((t,e)=>`${t}--${e}`)(e.type,t);let n=P.get(s);void 0===n&&(n={stringsArray:new WeakMap,keyString:new Map},P.set(s,n));let a=n.stringsArray.get(e.strings);if(void 0!==a)return a;const o=e.strings.join(i);if(a=n.keyString.get(o),void 0===a){const i=e.getTemplateElement();de&&fe.prepareTemplateDom(i,t),a=new r(e,i),n.keyString.set(o,a)}return n.stringsArray.set(e.strings,a),a})(t)(o)},ye=Qt(t=>class extends t{static get scopedElements(){return{}}static render(t,e,i){if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const{scopeName:s}=i,n=(r=this,pe.has(r)||pe.set(r,new Map),pe.get(r));var r;const a=ge(this),{scopedElements:o}=this;return super.render(t,e,{...i,templateFactory:we(s,o,n,a)})}defineScopedElement(t,e){return function(t,e,i){const s=i.get(t);s?void 0===customElements.get(s)&&ae(s,e,customElements):i.set(t,he(t,e,i))}(t,e,ge(this.constructor))}static getScopedTagName(t){const e=this.scopedElements[t];return e?he(t,e,ge(this)):ge(this).get(t)}}),_e=Qt(t=>class extends t{static get properties(){return{disabled:{type:Boolean,reflect:!0}}}constructor(){super(),this._requestedToBeDisabled=!1,this.g=!0,this.v=!1,this.disabled=!1}makeRequestToBeDisabled(){!1===this._requestedToBeDisabled&&(this._requestedToBeDisabled=!0,this.v=this.disabled,this._(!0))}retractRequestToBeDisabled(){!0===this._requestedToBeDisabled&&(this._requestedToBeDisabled=!1,this._(this.v))}_(t){this.g=!1,this.disabled=t,this.g=!0}requestUpdateInternal(t,e){super.requestUpdateInternal(t,e),"disabled"===t&&(this.g&&(this.v=this.disabled),!1===this.disabled&&!0===this._requestedToBeDisabled&&this._(!0))}}),xe=Qt(t=>class extends t{get slots(){return{}}constructor(){super(),this.S=new Set(null)}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this._connectSlotMixin()}_connectSlotMixin(){this.k||(Object.keys(this.slots).forEach(t=>{if(!this.querySelector(`[slot=${t}]`)){const e=(0,this.slots[t])();e instanceof Element&&(e.setAttribute("slot",t),this.appendChild(e),this.S.add(t))}}),this.k=!0)}_isPrivateSlot(t){return this.S.has(t)}}),Se=/Trident/.test(window.navigator.userAgent),ke=Qt(t=>class extends t{static get properties(){return{focused:{type:Boolean,reflect:!0}}}constructor(){super(),this.focused=!1}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this.M()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.C()}focus(){const t=this._inputNode;t&&t.focus()}blur(){const t=this._inputNode;t&&t.blur()}$(){this.focused=!0}A(){this.focused=!1}M(){this.T=t=>{t.stopPropagation(),this.dispatchEvent(new Event("focus"))},this._inputNode.addEventListener("focus",this.T),this.F=t=>{t.stopPropagation(),this.dispatchEvent(new Event("blur"))},this._inputNode.addEventListener("blur",this.F),this.P=t=>{t.stopPropagation(),this.$(),this.dispatchEvent(new Event("focusin",{bubbles:!0,composed:!0}))},this._inputNode.addEventListener("focusin",this.P),this.O=t=>{t.stopPropagation(),this.A(),this.dispatchEvent(new Event("focusout",{bubbles:!0,composed:!0}))},this._inputNode.addEventListener("focusout",this.O)}C(){this._inputNode.removeEventListener("focus",this.T),this._inputNode.removeEventListener("blur",this.F),this._inputNode.removeEventListener("focusin",this.P),this._inputNode.removeEventListener("focusout",this.O)}});class Me{constructor(t){this.type="unparseable",this.viewValue=t}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}}const Ce=Qt(t=>class extends t{static get properties(){return{modelValue:{attribute:!1},formattedValue:{attribute:!1},serializedValue:{attribute:!1},formatOn:{attribute:!1},formatOptions:{attribute:!1}}}requestUpdateInternal(t,e){super.requestUpdateInternal(t,e),"modelValue"===t&&this.modelValue!==e&&this._onModelValueChanged({modelValue:this.modelValue},{modelValue:e}),"serializedValue"===t&&this.serializedValue!==e&&this._calculateValues({source:"serialized"}),"formattedValue"===t&&this.formattedValue!==e&&this._calculateValues({source:"formatted"})}parser(t,e){return t}formatter(t,e){return t}serializer(t){return void 0!==t?t:""}deserializer(t){return void 0===t?"":t}_calculateValues({source:t}={source:null}){this.N||(this.N=!0,"model"!==t&&("serialized"===t?this.modelValue=this.deserializer(this.serializedValue):"formatted"===t&&(this.modelValue=this.j())),"formatted"!==t&&(this.formattedValue=this.V()),"serialized"!==t&&(this.serializedValue=this.serializer(this.modelValue)),this._reflectBackFormattedValueToUser(),this.N=!1)}j(t=this.formattedValue){if(""===t)return"";if("string"!=typeof t)return;const e=this.parser(t,this.formatOptions);return void 0!==e?e:new Me(t)}V(){return this.U&&this.hasFeedbackFor&&this.hasFeedbackFor.length&&this.hasFeedbackFor.includes("error")&&this._inputNode?this._inputNode?this.value:void 0:this.modelValue instanceof Me?this.modelValue.viewValue:this.formatter(this.modelValue,this.formatOptions)}_onModelValueChanged(...t){this._calculateValues({source:"model"}),this._dispatchModelValueChangedEvent(...t)}_dispatchModelValueChangedEvent(){this.dispatchEvent(new CustomEvent("model-value-changed",{bubbles:!0,detail:{formPath:[this]}}))}_syncValueUpwards(){this.modelValue=this.j(this.value)}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=void 0!==this.formattedValue?this.formattedValue:"")}_reflectBackOn(){return!this.U}_proxyInputEvent(){this.dispatchEvent(new CustomEvent("user-input-changed",{bubbles:!0,composed:!0}))}_onUserInputChanged(){this.U=!0,this._syncValueUpwards(),this.U=!1}constructor(){super(),this.formatOn="change",this.formatOptions={}}connectedCallback(){super.connectedCallback(),this._reflectBackFormattedValueToUser=this._reflectBackFormattedValueToUser.bind(this),this._reflectBackFormattedValueDebounced=()=>{setTimeout(this._reflectBackFormattedValueToUser)},this.addEventListener("user-input-changed",this._onUserInputChanged),void 0===this.modelValue&&this._syncValueUpwards(),this._reflectBackFormattedValueToUser(),this._inputNode&&(this._inputNode.addEventListener(this.formatOn,this._reflectBackFormattedValueDebounced),this._inputNode.addEventListener("input",this._proxyInputEvent))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("user-input-changed",this._onUserInputChanged),this._inputNode&&(this._inputNode.removeEventListener("input",this._proxyInputEvent),this._inputNode.removeEventListener(this.formatOn,this._reflectBackFormattedValueDebounced))}}),Ee=Qt(t=>class extends t{connectedCallback(){super.connectedCallback&&super.connectedCallback(),this.dispatchEvent(new CustomEvent("form-element-register",{detail:{element:this},bubbles:!0}))}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.I&&this.I.removeFormElement(this)}});function $e(t,{reverse:e}={}){const i=t.filter(t=>t);return i.sort((t,e)=>{const i=t.compareDocumentPosition(e);return i===Node.DOCUMENT_POSITION_PRECEDING||i===Node.DOCUMENT_POSITION_CONTAINED_BY?Se?-1:1:Se?1:-1}),e&&i.reverse(),i}const Ae=Qt(t=>class extends(Ee(xe(t))){static get properties(){return{name:{type:String,reflect:!0},label:String,helpText:{type:String,attribute:"help-text"},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.L||this._labelNode&&this._labelNode.textContent||""}set label(t){const e=this.label;this.L=t,this.requestUpdate("label",e)}get helpText(){return this.R||this._helpTextNode&&this._helpTextNode.textContent||""}set helpText(t){const e=this.helpText;this.R=t,this.requestUpdate("helpText",e)}get fieldName(){return this.D||this.label||this.name}set fieldName(t){this.D=t}get slots(){return{...super.slots,label:()=>{const t=document.createElement("label");return t.textContent=this.label,t},"help-text":()=>{const t=document.createElement("div");return t.textContent=this.helpText,t}}}updated(t){super.updated(t),t.has("_ariaLabelledNodes")&&this.B("aria-labelledby",this._ariaLabelledNodes,this.q),t.has("_ariaDescribedNodes")&&this.B("aria-describedby",this._ariaDescribedNodes,this.H),t.has("label")&&this._onLabelChanged({label:this.label}),t.has("helpText")&&this._onHelpTextChanged({helpText:this.helpText})}get _inputNode(){return this.J("input")}get _labelNode(){return this.J("label")}get _helpTextNode(){return this.J("help-text")}get _feedbackNode(){return this.J("feedback")}constructor(){super(),this._inputId=`${this.localName}-${Math.random().toString(36).substr(2,10)}`,this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole="child",this.addEventListener("model-value-changed",this.W)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent()}_triggerInitialModelValueChangedEvent(){this.G()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add("form-control")}_enhanceLightDomA11y(){const{_inputNode:t,_labelNode:e,_helpTextNode:i,_feedbackNode:s}=this;t&&(t.id=t.id||this._inputId),e&&(e.setAttribute("for",this._inputId),this.addToAriaLabelledBy(e,{idPrefix:"label"})),i&&this.addToAriaDescribedBy(i,{idPrefix:"help-text"}),s&&(s.setAttribute("aria-live","polite"),this.addToAriaDescribedBy(s,{idPrefix:"feedback"})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(t=["prefix","suffix","before","after"]){t.forEach(t=>{const e=this.J(t);e&&(!0===e.hasAttribute("data-label")&&this.addToAriaLabelledBy(e,{idPrefix:t}),!0===e.hasAttribute("data-description")&&this.addToAriaDescribedBy(e,{idPrefix:t}))})}B(t,e,i){if(this._inputNode){if(i){const t=e.filter(t=>this.contains(t)),i=e.filter(t=>!this.contains(t));e=[...$e(t),...i]}const s=e.map(t=>t.id).join(" ");this._inputNode.setAttribute(t,s)}}_onLabelChanged({label:t}){this._labelNode&&(this._labelNode.textContent=t)}_onHelpTextChanged({helpText:t}){this._helpTextNode&&(this._helpTextNode.textContent=t)}render(){return Nt`
...
function Ge(t,e,i){if(!(this instanceof Ge)||We.has(this))throw new TypeError("calling MessageFormat constructor without new is invalid");var s=He(t);We.set(this,{ast:s,format:qe(s,e,i&&i.types),locale:Ge.supportedLocalesOf(e)[0]||"en",locales:e,options:i})}var Ze=Ge;Object.defineProperties(Ge.prototype,{format:{configurable:!0,get:function(){var t=We.get(this);if(!t)throw new TypeError("MessageFormat.prototype.format called on value that's not an object initialized as a MessageFormat");return t.format}},formatToParts:{configurable:!0,writable:!0,value:function(t){var e=We.get(this);if(!e)throw new TypeError("MessageFormat.prototype.formatToParts called on value that's not an object initialized as a MessageFormat");return(e.toParts||(e.toParts=qe.toParts(e.ast,e.locales,e.options&&e.options.types)))(t)}},resolvedOptions:{configurable:!0,writable:!0,value:function(){var t=We.get(this);if(!t)throw new TypeError("MessageFormat.prototype.resolvedOptions called on value that's not an object initialized as a MessageFormat");return{locale:t.locale}}}}),"undefined"!=typeof Symbol&&Object.defineProperty(Ge.prototype,Symbol.toStringTag,{value:"Object"}),Object.defineProperties(Ge,{supportedLocalesOf:{configurable:!0,writable:!0,value:function(t){return[].concat(Intl.NumberFormat.supportedLocalesOf(t),Intl.DateTimeFormat.supportedLocalesOf(t),Intl.PluralRules?Intl.PluralRules.supportedLocalesOf(t):[],[].concat(t||[]).filter((function(t){return Je.test(t)}))).filter((function(t,e,i){return i.indexOf(t)===e}))}}});let Ke=Fe.get("@lion/localize::localize::0.10.x")||new class{constructor({autoLoadOnLocaleChange:t=!1,fallbackLocale:e=""}={}){this.K=document.createDocumentFragment(),this._autoLoadOnLocaleChange=!!t,this._fallbackLocale=e,this.Y={},this.X=new Map,this.tt={},this.nt={},this.formatNumberOptions={returnIfNaN:""};const i=document.documentElement.getAttribute("data-localize-lang");this._supportExternalTranslationTools=Boolean(i),this._supportExternalTranslationTools&&(this.locale=i||"en-GB",this._setupTranslationToolSupport()),document.documentElement.lang||(document.documentElement.lang=this.locale||"en-GB"),this._setupHtmlLangAttributeObserver()}_setupTranslationToolSupport(){this._langAttrSetByTranslationTool=document.documentElement.lang||null}teardown(){this._teardownHtmlLangAttributeObserver()}get locale(){return this._supportExternalTranslationTools?this.rt||"":document.documentElement.lang}set locale(t){let e;this._supportExternalTranslationTools?(e=this.rt,this.rt=t,null===this._langAttrSetByTranslationTool&&this._setHtmlLangAttribute(t)):(e=document.documentElement.lang,this._setHtmlLangAttribute(t)),t.includes("-")||this.at(t),this._onLocaleChanged(t,e)}_setHtmlLangAttribute(t){this._teardownHtmlLangAttributeObserver(),document.documentElement.lang=t,this._setupHtmlLangAttributeObserver()}at(t){throw new Error(`\n      Locale was set to ${t}.\n      Language only locales are not allowed, please use the full language locale e.g. 'en-GB' instead of 'en'.\n      See https://github.com/ing-bank/lion/issues/187 for more information.\n    `)}get loadingComplete(){return Promise.all(Object.values(this.nt[this.locale]))}reset(){this.Y={},this.X=new Map,this.tt={},this.nt={}}addData(t,e,i){if(this._isNamespaceInCache(t,e))throw new Error(`Namespace "${e}" has been already added for the locale "${t}".`);this.Y[t]=this.Y[t]||{},this.Y[t][e]=i}setupNamespaceLoader(t,e){this.X.set(t,e)}loadNamespaces(t,{locale:e}={}){return Promise.all(t.map(t=>this.loadNamespace(t,{locale:e})))}loadNamespace(t,{locale:e=this.locale}={locale:this.locale}){const i="object"==typeof t,s=i?Object.keys(t)[0]:t;if(this._isNamespaceInCache(e,s))return Promise.resolve();const n=this._getCachedNamespaceLoaderPromise(e,s);return n||this._loadNamespaceData(e,t,i,s)}msg(t,e,i={}){const s=i.locale?i.locale:this.locale,n=this._getMessageForKeys(t,s);return n?new Ze(n,s).format(e):""}_setupHtmlLangAttributeObserver(){this._htmlLangAttributeObserver||(this._htmlLangAttributeObserver=new MutationObserver(t=>{t.forEach(t=>{this._supportExternalTranslationTools?"auto"===document.documentElement.lang?(this._langAttrSetByTranslationTool=null,this._setHtmlLangAttribute(this.locale)):this._langAttrSetByTranslationTool=document.documentElement.lang:this._onLocaleChanged(document.documentElement.lang,t.oldValue||"")})})),this._htmlLangAttributeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:["lang"],attributeOldValue:!0})}_teardownHtmlLangAttributeObserver(){this._htmlLangAttributeObserver&&this._htmlLangAttributeObserver.disconnect()}_isNamespaceInCache(t,e){return!(!this.Y[t]||!this.Y[t][e])}_getCachedNamespaceLoaderPromise(t,e){return this.nt[t]?this.nt[t][e]:null}_loadNamespaceData(t,e,i,s){const n=this._getNamespaceLoader(e,i,s),r=this._getNamespaceLoaderPromise(n,t,s);return this._cacheNamespaceLoaderPromise(t,s,r),r.then(e=>{const i=function(t){return!(!t||!t.default||"object"!=typeof t.default||1!==Object.keys(t).length)}(e)?e.default:e;this.addData(t,s,i)})}_getNamespaceLoader(t,e,i){let s=this.tt[i];if(!s)if(e){s=t[i],this.tt[i]=s}else s=this._lookupNamespaceLoader(i),this.tt[i]=s;if(!s)throw new Error(`Namespace "${i}" was not properly setup.`);return this.tt[i]=s,s}_getNamespaceLoaderPromise(t,e,i,s=this._fallbackLocale){return t(e,i).catch(()=>{const n=this._getLangFromLocale(e);return t(n,i).catch(()=>{if(s)return this._getNamespaceLoaderPromise(t,s,i,"").catch(()=>{const t=this._getLangFromLocale(s);throw new Error(`Data for namespace "${i}" and current locale "${e}" or fallback locale "${s}" could not be loaded. Make sure you have data either for locale "${e}" (and/or generic language "${n}") or for fallback "${s}" (and/or "${t}").`)});throw new Error(`Data for namespace "${i}" and locale "${e}" could not be loaded. Make sure you have data for locale "${e}" (and/or generic language "${n}").`)})})}_cacheNamespaceLoaderPromise(t,e,i){this.nt[t]||(this.nt[t]={}),this.nt[t][e]=i}_lookupNamespaceLoader(t){for(const[e,i]of this.X){const s="string"==typeof e&&e===t,n="object"==typeof e&&"RegExp"===e.constructor.name&&e.test(t);if(s||n)return i}return null}_getLangFromLocale(t){return t.substring(0,2)}addEventListener(t,e,...i){this.K.addEventListener(t,e,...i)}removeEventListener(t,e,...i){this.K.removeEventListener(t,e,...i)}dispatchEvent(t){this.K.dispatchEvent(t)}_onLocaleChanged(t,e){t!==e&&(this._autoLoadOnLocaleChange&&this._loadAllMissing(t,e),this.dispatchEvent(new CustomEvent("localeChanged",{detail:{newLocale:t,oldLocale:e}})))}_loadAllMissing(t,e){const i=this.Y[e]||{},s=this.Y[t]||{},n=[];return Object.keys(i).forEach(e=>{s[e]||n.push(this.loadNamespace(e,{locale:t}))}),Promise.all(n)}_getMessageForKeys(t,e){if("string"==typeof t)return this._getMessageForKey(t,e);const i=Array.from(t).reverse();let s,n;for(;i.length;)if(s=i.pop(),n=this._getMessageForKey(s,e),n)return n}_getMessageForKey(t,e){if(!t||-1===t.indexOf(":"))throw new Error(`Namespace is missing in the key "${t}". The format for keys is "namespace:name".`);const[i,s]=t.split(":"),n=this.Y[e],r=n?n[i]:{},a=s.split(".").reduce((t,e)=>"object"==typeof t?t[e]:t,r);return String(a||"")}}({autoLoadOnLocaleChange:!0,fallbackLocale:"en-GB"});class Ye extends Kt{static get properties(){return{feedbackData:Array}}_messageTemplate({message:t}){return t}updated(){super.updated(),this.feedbackData&&this.feedbackData[0]?(this.setAttribute("type",this.feedbackData[0].type),this.currentType=this.feedbackData[0].type,window.clearTimeout(this.removeMessage),"success"===this.currentType&&(this.removeMessage=window.setTimeout(()=>{this.removeAttribute("type"),this.feedbackData=""},3e3))):"success"!==this.currentType&&this.removeAttribute("type")}render(){return Nt`
      ${this.feedbackData&&this.feedbackData.map(({message:t,type:e,validator:i})=>Nt`
        ...
        `)}
    `}}class Qe{constructor(t,e){!function(t){const e=document.createDocumentFragment();t.addEventListener=(t,i,s)=>e.addEventListener(t,i,s),t.dispatchEvent=t=>e.dispatchEvent(t),t.removeEventListener=(t,i,s)=>e.removeEventListener(t,i,s)}(this),this.ot=t,this.ht=e||{},this.type=e&&e.type||"error"}static get validatorName(){return""}static get async(){return!1}execute(){if(!this.validatorName)throw new Error("A validator needs to have a name! Please set it via \"static get validatorName() { return 'IsCat'; }\"")}set param(t){this.ot=t,this.dispatchEvent(new Event("param-changed"))}get param(){return this.ot}set config(t){this.ht=t,this.dispatchEvent(new Event("config-changed"))}get config(){return this.ht}async _getMessage(t){const e={name:this.constructor.validatorName,type:this.type,params:this.param,config:this.config,...t};if(this.config.getMessage){if("function"==typeof this.config.getMessage)return this.config.getMessage(e);throw new Error("You must provide a value for getMessage of type 'function', you provided a value of type: "+typeof this.config.getMessage)}return this.constructor.getMessage(e)}static async getMessage(){return`Please configure an error message for "${this.name}" by overriding "static async getMessage()"`}onFormControlConnect(t){}onFormControlDisconnect(t){}abortExecution(){}}class Xe extends Qe{executeOnResults({validationResult:t,prevValidationResult:e,validators:i}){}}class ti{constructor(){this.ct=!1,this.ut=[]}add(t){this.ut.push(t),this.ct||(this.complete=new Promise(t=>{this.dt=t}),this.ft())}async ft(){this.ct=!0,await this.ut[0](),this.ut.shift(),this.ut.length>0?this.ft():(this.ct=!1,this.dt&&this.dt())}}const ei=Qt(t=>class extends t{constructor(){super(),this.gt={}}firstUpdated(t){super.firstUpdated(t),this.gt.connected=!0,this.vt()}disconnectedCallback(){super.disconnectedCallback(),this.gt.connected=!1}static bt(t,e,i){const s=this._classProperties;return s.get(t)&&s.get(t).hasChanged?s.get(t).hasChanged(e,i):e!==i}vt(){const t=this.gt,e=this.constructor;t.initialized=!0,t.queue&&Array.from(t.queue).forEach(t=>{e.bt(t,this[t],void 0)&&this.updateSync(t,void 0)})}requestUpdateInternal(t,e){super.requestUpdateInternal(t,e),this.gt=this.gt||{};const i=this.gt,s=this.constructor;i.connected?s.bt(t,this[t],e)&&this.updateSync(t,e):(i.queue=i.queue||new Set,i.queue.add(t))}updateSync(t,e){}});class ii extends Qe{static get validatorName(){return"Required"}onFormControlConnect(t){t._inputNode&&t._inputNode.setAttribute("aria-required","true")}onFormControlDisconnect(t){t._inputNode&&t._inputNode.removeAttribute("aria-required")}}function si(t=[],e=[]){return t.filter(t=>!e.includes(t)).concat(e.filter(e=>!t.includes(e)))}const ni=Qt(t=>class extends(ei(xe(ye(t)))){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":Ye}}static get properties(){return{validators:Array,hasFeedbackFor:{type:Array},shouldShowFeedbackFor:{type:Array},showsFeedbackFor:{type:Array,attribute:"shows-feedback-for",reflect:!0,converter:{fromAttribute:t=>t.split(","),toAttribute:t=>t.join(",")}},validationStates:{type:Object},isPending:{type:Boolean,attribute:"is-pending",reflect:!0},modelValue:Object,defaultValidators:Array,_visibleMessagesAmount:Number,fieldName:String}}static get validationTypes(){return["error"]}get slots(){return{...super.slots,feedback:()=>document.createElement(this.constructor.getScopedTagName("lion-validation-feedback"))}}get _feedbackNode(){return this.querySelector("[slot=feedback]")}get _allValidators(){return[...this.validators,...this.defaultValidators]}constructor(){super(),this.hasFeedbackFor=[],this.shouldShowFeedbackFor=[],this.showsFeedbackFor=[],this.validationStates={},this._visibleMessagesAmount=1,this.isPending=!1,this.validators=[],this.defaultValidators=[],this.wt=[],this.yt=[],this._t=[],this.xt=this.xt.bind(this),this._updateFeedbackComponent=this._updateFeedbackComponent.bind(this)}connectedCallback(){super.connectedCallback(),Ke.addEventListener("localeChanged",this._updateFeedbackComponent)}disconnectedCallback(){super.disconnectedCallback(),Ke.removeEventListener("localeChanged",this._updateFeedbackComponent)}firstUpdated(t){super.firstUpdated(t),this.St=!0,this.validate()}updateSync(t,e){if(super.updateSync(t,e),"validators"===t?(this.kt(),this.validate({clearCurrentResult:!0})):"modelValue"===t&&this.validate({clearCurrentResult:!0}),["touched","dirty","prefilled","submitted","hasFeedbackFor"].includes(t)&&this._updateShouldShowFeedbackFor(),"showsFeedbackFor"===t){this._inputNode&&this._inputNode.setAttribute("aria-invalid",this._hasFeedbackVisibleFor("error"));const t=si(this.showsFeedbackFor,e);t.length>0&&this.dispatchEvent(new Event("showsFeedbackForChanged",{bubbles:!0})),t.forEach(t=>{var e;this.dispatchEvent(new Event(`showsFeedbackFor${e=t,e.charAt(0).toUpperCase()+e.slice(1)}Changed`,{bubbles:!0}))})}if("shouldShowFeedbackFor"===t){si(this.shouldShowFeedbackFor,e).length>0&&this.dispatchEvent(new Event("shouldShowFeedbackForChanged",{bubbles:!0}))}}async validate({clearCurrentResult:t}={}){if(this.disabled)return this.Mt(),this.Ct({source:"sync",hasAsync:!0}),void this._updateFeedbackComponent();this.St&&(this.Et(),t&&this.Mt(),await this.$t())}Et(){this.At=this._t}async $t(){this.validateComplete=new Promise(t=>{this.Tt=t});const t=this.modelValue instanceof Me?this.modelValue.viewValue:this.modelValue,e=this._allValidators.find(t=>t instanceof ii);if(this.Ft(t))return e&&(this.wt=[e]),void this.Ct({source:"sync"});const i=this._allValidators.filter(t=>!(t instanceof Xe||t instanceof ii)),s=i.filter(t=>!t.constructor.async),n=i.filter(t=>t.constructor.async);this.Pt(s,t,{hasAsync:Boolean(n.length)}),await this.Ot(n,t)}Pt(t,e,{hasAsync:i}){t.length&&(this.wt=t.filter(t=>t.execute(e,t.param,{node:this}))),this.Ct({source:"sync",hasAsync:i})}async Ot(t,e){if(t.length){this.isPending=!0;const i=t.map(t=>t.execute(e,t.param,{node:this})),s=await Promise.all(i);this.yt=s.map((e,i)=>t[i]).filter((t,e)=>s[e]),this.Ct({source:"async"}),this.isPending=!1}}Nt(t){return this._allValidators.filter(t=>!t.constructor.async&&t instanceof Xe).filter(e=>e.executeOnResults({regularValidationResult:t,prevValidationResult:this.At}))}Ct({source:t,hasAsync:e}){const i=[...this.wt,...this.yt],s=this.Nt(i);this._t=[...s,...i];const n=this.constructor.validationTypes.reduce((t,e)=>({...t,[e]:{}}),{});this._t.forEach(t=>{n[t.type]||(n[t.type]={}),n[t.type][t.constructor.validatorName]=!0}),this.validationStates=n,this.hasFeedbackFor=[...new Set(this._t.map(t=>t.type))],this.dispatchEvent(new Event("validate-performed",{bubbles:!0})),"async"!==t&&e||this.Tt()}Mt(){this.wt=[],this.yt=[]}xt(t){"param-changed"!==t.type&&"config-changed"!==t.type||this.validate()}kt(){const t=["param-changed","config-changed"];this.jt&&this.jt.forEach(e=>{t.forEach(t=>e.removeEventListener(t,this.xt)),e.onFormControlDisconnect(this)}),this._allValidators.forEach(e=>{if(!(e instanceof Qe)){const t=`Validators array only accepts class instances of Validator. Type "${Array.isArray(e)?"array":typeof e}" found.`;throw console.error(t,this),new Error(t)}if(-1===this.constructor.validationTypes.indexOf(e.type)){const t=`This component does not support the validator type "${e.type}" used in "${e.constructor.validatorName}". You may change your validators type or add it to the components "static get validationTypes() {}".`;throw console.error(t,this),new Error(t)}t.forEach(t=>e.addEventListener(t,this.xt)),e.onFormControlConnect(this)}),this.jt=this._allValidators}static _hasObjectChanged(t,e){return JSON.stringify(t)!==JSON.stringify(e)}Ft(t){return"function"==typeof this._isEmpty?this._isEmpty(t):null===this.modelValue||void 0===this.modelValue||""===this.modelValue}async Vt(t){let e=await this.fieldName;return Promise.all(t.map(async t=>(t.config.fieldName&&(e=await t.config.fieldName),{message:await t._getMessage({modelValue:this.modelValue,formControl:this,fieldName:e}),type:t.type,validator:t})))}_updateFeedbackComponent(){this._feedbackNode&&(this.zt||(this.zt=new ti),this.showsFeedbackFor.length>0?this.zt.add(async()=>{this.Ut=this._prioritizeAndFilterFeedback({validationResult:this._t});const t=await this.Vt(this.Ut);this._feedbackNode.feedbackData=t.length?t:[]}):this.zt.add(async()=>{this._feedbackNode.feedbackData=[]}),this.feedbackComplete=this.zt.complete)}_showFeedbackConditionFor(){return this.touched&&this.dirty||this.prefilled||this.submitted}_hasFeedbackVisibleFor(t){return this.hasFeedbackFor&&this.hasFeedbackFor.includes(t)&&this.shouldShowFeedbackFor&&this.shouldShowFeedbackFor.includes(t)}updated(t){super.updated(t),(t.has("shouldShowFeedbackFor")||t.has("hasFeedbackFor"))&&(this.showsFeedbackFor=this.constructor.validationTypes.map(t=>this._hasFeedbackVisibleFor(t)?t:void 0).filter(t=>!!t),this._updateFeedbackComponent())}_updateShouldShowFeedbackFor(){this.shouldShowFeedbackFor=this.constructor.validationTypes.map(t=>this._showFeedbackConditionFor(t)?t:void 0).filter(t=>!!t)}_prioritizeAndFilterFeedback({validationResult:t}){const e=this.constructor.validationTypes;return t.sort((t,i)=>e.indexOf(t.type)-e.indexOf(i.type)).slice(0,this._visibleMessagesAmount)}});class ri extends(Ae(Te(ke(Ce(ni(_e(xe(Kt)))))))){static get properties(){return{submitted:{type:Boolean},autocomplete:{type:String,reflect:!0},value:{type:String}}}get selectionStart(){const t=this._inputNode;return t&&t.selectionStart?t.selectionStart:0}set selectionStart(t){const e=this._inputNode;e&&e.selectionStart&&(e.selectionStart=t)}get selectionEnd(){const t=this._inputNode;return t&&t.selectionEnd?t.selectionEnd:0}set selectionEnd(t){const e=this._inputNode;e&&e.selectionEnd&&(e.selectionEnd=t)}set value(t){this._inputNode?(this._setValueAndPreserveCaret(t),this.It=void 0):this.It=t}get value(){return this._inputNode&&this._inputNode.value||this.It||""}constructor(){super(),this.name="",this.submitted=!1}firstUpdated(t){super.firstUpdated(t),this._initialModelValue=this.modelValue}connectedCallback(){super.connectedCallback(),this._onChange=this._onChange.bind(this),this._inputNode.addEventListener("change",this._onChange),this.classList.add("form-field")}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener("change",this._onChange)}updated(t){super.updated(t),t.has("disabled")&&(this._inputNode.disabled=this.disabled,this.validate()),t.has("name")&&(this._inputNode.name=this.name),t.has("autocomplete")&&(this._inputNode.autocomplete=this.autocomplete)}resetInteractionState(){super.resetInteractionState&&super.resetInteractionState(),this.submitted=!1}reset(){this.modelValue=this._initialModelValue,this.resetInteractionState()}clear(){super.clear&&super.clear(),this.modelValue=""}_onChange(){super._onChange&&super._onChange(),this.dispatchEvent(new CustomEvent("user-input-changed",{bubbles:!0}))}_setValueAndPreserveCaret(t){if(this.focused)try{const e=this._inputNode.selectionStart;this._inputNode.value=t,this._inputNode.selectionStart=e,this._inputNode.selectionEnd=e}catch(e){this._inputNode.value=t}else this._inputNode.value=t}}function ai(t,e){if(function(t){return t?new RegExp("^(|/)"+t.replace(/:[^\s/]+/g,"([\\wÀ-ÖØ-öø-ÿ-]+)")+"(|/)$"):new RegExp("(^$|^/$)")}(e).test(t))return!0}function oi(t){return class extends t{static get properties(){return{route:{type:String,reflect:!0,attribute:"route"},canceled:{type:Boolean}}}constructor(...t){super(...t),this.route="",this.canceled=!1}connectedCallback(...t){super.connectedCallback(...t),this.routing(this.constructor.routes,(...t)=>this.router(...t)),window.addEventListener("route",()=>{this.routing(this.constructor.routes,(...t)=>this.router(...t))}),window.onpopstate=()=>{window.dispatchEvent(new CustomEvent("route"))}}routed(t,e,i,s,n,r){r&&r(t,e,i,s),n(t,e,i,s)}routing(t,e){this.canceled=!0;const i=decodeURI(window.location.pathname),s=decodeURI(window.location.search);let n=t.filter(t=>"*"===t.pattern)[0],r=t.filter(t=>"*"!==t.pattern&&ai(i,t.pattern))[0],a=function(t){return t?JSON.parse('{"'+t.substring(1).replace(/&/g,'","').replace(/=/g,'":"')+'"}'):{}}(s);r?(r.params=function(t,e){let i={};const s=t.split("/").filter(t=>""!=t),n=e.split("/").filter(t=>""!=t);return s.map((t,e)=>{/^:/.test(t)&&(i[t.substring(1)]=n[e])}),i}(r.pattern,i),r.data=r.data||{},r.authentication&&r.authentication.authenticate&&"function"==typeof r.authentication.authenticate?(this.canceled=!1,Promise.resolve(r.authentication.authenticate.bind(this).call()).then(t=>{this.canceled||(t?r.authorization&&r.authorization.authorize&&"function"==typeof r.authorization.authorize?(this.canceled=!1,Promise.resolve(r.authorization.authorize.bind(this).call()).then(t=>{this.canceled||(t?this.routed(r.name,r.params,a,r.data,e,r.callback):this.routed(r.authorization.unauthorized.name,r.params,a,r.data,e,r.callback))})):this.routed(r.name,r.params,a,r.data,e,r.callback):this.routed(r.authentication.unauthenticated.name,r.params,a,r.data,e,r.callback))})):r.authorization&&r.authorization.authorize&&"function"==typeof r.authorization.authorize?(this.canceled=!1,Promise.resolve(r.authorization.authorize.bind(this).call()).then(t=>{this.canceled||(t?this.routed(r.name,r.params,a,r.data,e,r.callback):this.routed(r.authorization.unauthorized.name,r.params,a,r.data,e,r.callback))})):this.routed(r.name,r.params,a,r.data,e,r.callback)):n&&(n.data=n.data||{},this.routed(n.name,{},a,n.data,e,n.callback))}}}customElements.define("lion-input",class extends ri{static get properties(){return{readOnly:{type:Boolean,attribute:"readonly",reflect:!0},type:{type:String,reflect:!0},placeholder:{type:String,reflect:!0}}}get slots(){return{...super.slots,input:()=>{const t=document.createElement("input");return this.hasAttribute("value")&&t.setAttribute("value",this.getAttribute("value")),t}}}constructor(){super(),this.readOnly=!1,this.type="text"}requestUpdateInternal(t,e){super.requestUpdateInternal(t,e),"readOnly"===t&&this.Lt()}firstUpdated(t){super.firstUpdated(t),this.Lt()}updated(t){super.updated(t),t.has("type")&&(this._inputNode.type=this.type),t.has("placeholder")&&(this._inputNode.placeholder=this.placeholder)}Lt(){this._inputNode&&(this._inputNode.readOnly=this.readOnly)}});class hi extends(function(t){return class extends t{navigate(t){window.history.pushState({},null,t),window.dispatchEvent(new CustomEvent("route"))}}}(Y)){static get properties(){return{href:{type:String}}}static get styles(){return Z`
      a {
        margin: 5px;
    ...
    `}linkClick(t){t.preventDefault(),this.navigate(this.href)}}customElements.define("nav-link",hi);var ci=Z`
    :host {
        --orange-bg-color: #FF6200;
    }
`;customElements.define("fa-icon",class extends Y{static get properties(){return{color:String,iClass:{attribute:"class"},src:String,style:String,size:String,pathPrefix:{attribute:"path-prefix"}}}static get styles(){return Z`
      :host {
    ...
    `}});customElements.define("app-logo-element",class extends Y{static get styles(){return Z`
            :host {
                display: inline-block;
            }
            .triangle {
        ...
        <div class="triangle">
            <div class="empty"></div>
        </div>`}});customElements.define("header-element",class extends Y{static get styles(){return[ci,Z`
            :host {
                display: block;
            }
        ...
        `]}openDrawer(t){this.shadowRoot.getElementById("drawer").style.width="250px",t.preventDefault()}closeDrawer(t){this.shadowRoot.getElementById("drawer").style.width="0"}render(){return j`
    ...
    `}}window.customElements.define("app-root",ui);export{ui as AppRoot};
