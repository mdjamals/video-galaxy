...
const vi=(t,e)=>{const i=t.startNode.parentNode,s=void 0===e?t.endNode:e.startNode,n=i.insertBefore(h(),s);i.insertBefore(h(),s);const r=new k(t.options);return r.insertAfterNode(n),r},bi=(t,e)=>(t.setValue(e),t.commit(),t),wi=(t,e,i)=>{const s=t.startNode.parentNode,n=i?i.startNode:t.endNode,r=e.endNode.nextSibling;r!==n&&((t,e,i=null,s=null)=>{for(;e!==i;){const i=e.nextSibling;t.insertBefore(e,s),e=i}})(s,e.startNode,r,n)},yi=t=>{e(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},xi=(t,e,i)=>{const s=new Map;for(let n=e;n<=i;n++)s.set(t[n],n);return s},_i=new WeakMap,Si=new WeakMap,ki=(t=>(...e)=>{const i=t(...e);return p.set(i,!0),i})((t,e,i)=>{let s;return void 0===i?i=e:void 0!==e&&(s=e),e=>{if(!(e instanceof k))throw new Error("repeat can only be used in text bindings");const n=_i.get(e)||[],r=Si.get(e)||[],a=[],o=[],h=[];let c,l,u=0;for(const e of t)h[u]=s?s(e,u):u,o[u]=i(e,u),u++;let d=0,p=n.length-1,f=0,m=o.length-1;for(;d<=p&&f<=m;)if(null===n[d])d++;else if(null===n[p])p--;else if(r[d]===h[f])a[f]=bi(n[d],o[f]),d++,f++;else if(r[p]===h[m])a[m]=bi(n[p],o[m]),p--,m--;else if(r[d]===h[m])a[m]=bi(n[d],o[m]),wi(e,n[d],a[m+1]),d++,m--;else if(r[p]===h[f])a[f]=bi(n[p],o[f]),wi(e,n[p],n[d]),p--,f++;else if(void 0===c&&(c=xi(h,f,m),l=xi(r,d,p)),c.has(r[d]))if(c.has(r[p])){const t=l.get(h[f]),i=void 0!==t?n[t]:null;if(null===i){const t=vi(e,n[d]);bi(t,o[f]),a[f]=t}else a[f]=bi(i,o[f]),wi(e,i,n[d]),n[t]=null;f++}else yi(n[p]),p--;else yi(n[d]),d++;for(;f<=m;){const t=vi(e,a[m+1]);bi(t,o[f]),a[f++]=t}for(;d<=p;){const t=n[d++];null!==t&&yi(t)}_i.set(e,a),Si.set(e,h)}});customElements.define("video-grid-element",class extends K{constructor(){super()}static get properties(){return{snippet:{type:Object},heading:{type:String}}}static get styles(){return Y`
    ...
    `}render(){console.log("video snippets...",this.snippet);let{items:t}=this.snippet.result,e=j`No contents to show!`;return t&&(e=j`
        ...
        `}async connectedCallback(){this.moviesData=await this.ytApi.loadContents(mi.movies),super.connectedCallback()}render(){return console.log("render movies...",this.moviesData),j`<video-grid-element snippet='${JSON.stringify(this.moviesData)}' heading='Movies'></video-grid-element>`}});customElements.define("search-contents-element",class extends K{constructor(){super(),this.eventEmitter=Fe.get(fi),this.eventEmitter.subscribe("start-search",this.search.bind(this)),this.ytApi=Fe.get(di)}static get styles(){return Y`
            :host {
                display: block;
            }
